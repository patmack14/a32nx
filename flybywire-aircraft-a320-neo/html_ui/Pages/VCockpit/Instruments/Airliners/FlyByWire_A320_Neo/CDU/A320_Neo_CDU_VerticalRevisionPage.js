...
class CDUVerticalRevisionPage {
    static ShowPage(mcdu, waypoint, verticalWaypoint, isDescentWaypoint, confirmSpeed = undefined, confirmAlt = undefined, confirmCode = undefined) {
        ...
        if (waypointInfo instanceof WayPointInfo) {
            ...
            const confirmConstraint = confirmSpeed !== undefined || confirmAlt !== undefinasdfasded;
            ...
            mcdu.onLeftInput[1] = (value, scratchpadCallback) => {
                ...
                const m = value.match(/^([0-9]{1,3})\/(((FL)?([0-9]{1,3}))|([0-9]{4,5}))$/);
                if (m === null) {
                ...
                let alt = m[5] !== undefined ? parseInt(m[5]) * 100 : parseInt(m[6]);
            ...
            mcdu.onLeftInput[2] = async (value, scratchpadCallback) => {
                if (value === FMCMainDisplay.clrValue) {
                    mcdu.flightPlanManager.setWaypointSpeed(-1, mcdu.flightPlanManager.indexOfWaypoint(waypoint), () => {
            ...
            mcdu.onRightInput[2] = (value, scratchpadCallback) => {
                if (value === FMCMainDisplay.clrValue) {
                    ...
                    mcdu.flightPlanManager.setWaypointAltitude(0, mcdu.flightPlanManager.indexOfWaypoint(waypoint), () => {
                ...
                const m = value.match(/^([+-])?(((FL)?([0-9]{1,3}))|([0-9]{4,5}))$/);
                if (m === null) {
                    mcdu.addNewMessage(NXSystemMessages.formatError);
                ...
                const altitude = m[5] !== undefined ? parseInt(m[5]) * 100 : parseInt(m[6]);
                ...
                const code = m[1] === undefined ? 1 : (m[1] === '-' ? 3 : 2);
            ...
            if (!confirmConstraint) {
                ...
                mcdu.onLeftInput[5] = () => {
                    if (confirmSpeed !== undefined) {
                        mcdu.flightPlanManager.setWaypointSpeed(confirmSpeed, mcdu.flightPlanManager.indexOfWaypoint(waypoint), () => {
                            this.ShowPage(mcdu, waypoint);
                        }, false);
                    }
                    if (confirmAlt !== undefined) {
                        mcdu.flightPlanManager.setLegAltitudeDescription(waypoint, confirmCode);
                        mcdu.flightPlanManager.setWaypointAltitude(confirmAlt, mcdu.flightPlanManager.indexOfWaypoint(waypoint), () => {
                            this.ShowPage(mcdu, waypoint);
                        }, false);
                    }
                };
    ...
    static setConstraints(mcdu, waypoint, value, scratchpadCallback, offset = 0) {
        ...
        const code = m[4] === undefined ? 1 : (m[4] === '-' ? 3 : 2);

        if (m[8] !== undefined) {
            alt = parseInt(m[8]) * 100;
        }
